...
@ccclass
export default class NativeBanner2 extends cc.Component {
    static instance: NativeBanner2 = null;
    desLabel: cc.Label;
    imgSprite: cc.Sprite;
    nativeAd: any;
    nativeCurrentAd: any;
    ...
    loadNaitveAd(){
        ...
        this.nativeAd.onLoad((res)=> {
            ...
            if (res && res.adList) {
                ...
                let imgUrl = this.nativeCurrentAd.icon;
